...
public class ExampleModel2 extends STTKModel {
	...
	final static Identifier CI_CD = new Identifier("CI/CD server", "The Continues Integration and Continues Deployment server");
	...
	final static Identifier CI_CD_SERVER = new Identifier("CI/CD Tool");
	final static Identifier DOCKER = new Identifier("Docker");
	...
	public ExampleModel2() {
		...
		sc.system(CI_CD).zoomIn().container(CI_CD_SERVER).does("eats").container(DOCKER);
	}
	/* @formatter:on */
}
